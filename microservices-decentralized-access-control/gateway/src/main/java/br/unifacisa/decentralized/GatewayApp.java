package br.unifacisa.decentralized;

import br.unifacisa.decentralized.config.ApplicationProperties;
import br.unifacisa.decentralized.config.DefaultProfileUtil;
